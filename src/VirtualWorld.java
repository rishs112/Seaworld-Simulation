   ...
   extends PApplet
{
   ...
   */
   ...
   public void mousePressed() {
      Point currentMouse = mouseToPoint(mouseX, mouseY);

      Monster entity = new Monster(currentMouse, Functions.getImageList(imageStore, "monster"));
                                      ...
                                      EventScheduler scheduler, ImageStore imageStore)
   {
      for (Entity entity : world.entities)
      {
         ...
         if (entity.getActionPeriod() > 0)
            if (entity instanceof OtherFuncs)
               ((OtherFuncs)entity).scheduleActions(scheduler, world, imageStore);
      }
   }
   ...
   public Point mouseToPoint(int x, int y) {
      ...
      return new Point((mouseX/TILE_SIZE) + changeX, (mouseY/TILE_SIZE) + changeY);
   }
